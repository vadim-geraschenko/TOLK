...
const episodeBreadcrumbParents: Record<
  Episode["kind"],
...
export function EpisodePage({ episode }: { episode: Episode }) {
  ...
  const hosts = episode.participants.filter(
          ...
          <>
            <section className={cx("hero", "container")}>
              <div className={cx("breadcrumbs")}>
                ...
                <span>›</span>
                <a href={withBasePath(breadcrumbParent.href)}>
                ...
                <article className={cx("panel", "short-info-panel")}>
                  <div className={cx("short-source-block")}>
                    {sourceEpisode ? (
                      ...
                      <p className={cx("timestamps-empty")}>
                        Исходный выпуск скоро будет добавлен.
                      </p>
                    )}
                    {sourceEpisode ? (
                      <a
                        className={cx("button", "support-link")}
                        href={withBasePath(`/episodes/${sourceEpisode.slug}`)}
                      >
                        <span className={cx("button-label")}>
                          Смотреть полный разговор
                        </span>
                          ...
                          <article className={cx("guest-row")}>
                            ...
                            <div>
                              ...
                              <p className={cx("guest-note")}>
                                Данные участников скоро появятся.
                              </p>
                            </div>
                          </article>
                        )}
